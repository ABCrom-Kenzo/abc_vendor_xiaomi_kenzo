...
PRODUCT_COPY_FILES += vendor/xiaomi/kenzo/proprietary/etc/mbn_ota.txt:system/etc/mbn_ota.txt 

PRODUCT_COPY_FILES += vendor/xiaomi/kenzo/proprietary/vendor/Diag.cfg:system/vendor/Diag.cfg
